...
data PerGHC a = PerGHC a a a a a a a a
  deriving (Functor, Foldable, Traversable)

index :: PerGHC a -> GHCVer -> a
index (PerGHC x _ _ _ _ _ _ _) GHC_7_0 = x
index (PerGHC _ x _ _ _ _ _ _) GHC_7_2 = x
index (PerGHC _ _ x _ _ _ _ _) GHC_7_4 = x
index (PerGHC _ _ _ x _ _ _ _) GHC_7_6 = x
index (PerGHC _ _ _ _ x _ _ _) GHC_7_8 = x
index (PerGHC _ _ _ _ _ x _ _) GHC_7_10 = x
index (PerGHC _ _ _ _ _ _ x _) GHC_8_0 = x
index (PerGHC _ _ _ _ _ _ _ x) GHC_8_2 = x
